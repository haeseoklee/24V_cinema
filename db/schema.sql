...
INSERT INTO `movie` (`id`, `title`, `img`) VALUES (NULL, '북간도의 십자가', '/movies/images/bukgando.jpg');
INSERT INTO `movie` (`id`, `title`, `img`) VALUES (NULL, '닥터슬립', '/movies/images/doctorsleep.jpg');
INSERT INTO `movie` (`id`, `title`, `img`) VALUES (NULL, '82년생 김지영', '/movies/images/kimjiyoung.jpg');
INSERT INTO `movie` (`id`, `title`, `img`) VALUES (NULL, '말레피센트2', '/movies/images/malle.jpg');
INSERT INTO `movie` (`id`, `title`, `img`) VALUES (NULL, '날씨의 아이', '/movies/images/nalssi.jpg');
INSERT INTO `movie` (`id`, `title`, `img`) VALUES (NULL, '겨울왕국2', '/movies/images/Frozen2.jpg');
...
INSERT INTO movie (title, img, director, genre, runtime, story)
VALUES ('겨울왕국 2', '/movies/images/Frozen2.jpg', "크리스 벅", "애니메이션", "01:43:00",
"내 마법의 힘은 어디서 왔을까?
나를 부르는 저 목소리는 누구지?
